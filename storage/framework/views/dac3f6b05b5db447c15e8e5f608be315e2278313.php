                    ...
                    <img src="../upload/avatar/<?php echo e(Auth::user()->avatar); ?>" width="50px" height="50px" style="border-radius:50%" alt="">
                        ...
                        <div id="myDropdown" class="dropdown-content">
                            <?php if(Auth::user()->role == 1): ?>     
                                <a href="<?php echo e(('admin')); ?>">Quản trị</a>
                                ...
                                <a href="<?php echo e(url('trang-ca-nhan')); ?> ">Trang cá nhân</a>
                            <?php else: ?>   
                                <a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
                                    onclick="event.preventDefault();
                                                document.getElementById('logout-form').submit();">
...
</html><?php /**PATH C:\xampp\htdocs\blog\resources\views/welcome.blade.php ENDPATH**/ ?>